      ...
      <div class="relative z-10 max-w-md mx-auto bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 sm:p-10 overflow-hidden">
        ...
        <form @submit.prevent="isStepOne ? nextStep() : submit()">
          ...
          <div v-if="isStepOne" class="space-y-6">
            ...
            <div class="mt-4">
              <InputLabel for="is_hotel" value="Je suis un hôtel" class="flex items-center gap-2" />
              <input
                id="is_hotel"
                type="checkbox"
            ...
            <div v-if="form.is_hotel" class="register-step-1">
              <InputLabel for="company_name" value="Nom de l'établissement" class="text-gray-700 mb-2 block font-medium"/>
              <TextInput
                id="company_name"
                type="text"
                :class="inputClass"
